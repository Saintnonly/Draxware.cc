...
if not isfolder("draxware") then
    makefolder("draxware")
end

if not isfolder("draxware/configs") then
    makefolder("draxware/configs")
end

if not isfolder("draxware/configs/da_hood") then
    makefolder("draxware/configs/da_hood")
end
...
local UserInterface = (function() -- src/Lua/Interface/Interface.Lua
    ...
    function UserInterface:Create(OptionsLaughtOutLouds)
        ...
        UI["a"]["Text"] = [[powered by Sophie Rain]]
                ...
                do -- src/Lua/Interface/Components/
                    ...
                    do -- src/Lua/Interface/Components/Colorpicker.lua
                        function Options:Colorpicker(Configuration, ToggleOption)
                            ...
                            ColorpickerStatus.BackgroundColor3 = Color3FromRGB(250, 3, 0)
                            ...
                            ColorpickerInline.BackgroundColor3 = Color3FromRGB(250, 3, 0)
                            ...
                            Accent.BackgroundColor3 = Color3FromRGB(250, 3, 0)
                            ...
                            function Dropdown:CreateValue(name)
                                if not Dropdown.FValues[name] then
                                    ...
                                    local function Click()
                                        DBName.TextColor3 = Color3.fromRGB(250, 3, 0)
                    ...
                    do -- src/Lua/Interface/Components/Keybind.lua
                        function Options:Keybind(Configuration, toggle)
                            ...
                            KeybindInline.BackgroundColor3 = Color3FromRGB(250, 3, 0)
                            ...
                            for _, v in pairs({ "Toggle", "Hold", "Always" }) do
                                ...
                                function Button:Click(igr)
                                    ...
                                    KB_Button.TextColor3 = Color3FromRGB(250, 3, 0)
                    ...
                    do -- src/Lua/Interface/Components/Toggle.lua
                        function Options:Toggle(Configuration)
                            ...
                            local TS_ON = tweenService:Create(ToggleStatus, TweenInfo.new(0.2), {
                                BackgroundColor3 = Color3FromRGB(250, 3, 0)
                            })
    ...
    local function my_script()
        ...
        if chosen_game == "da_hood" then
            (function() -- src/Lua/Scripts/da_hood/da_hood.lua
                ...
                if please_load then
                    ...
                    local Interface = UserInterface:Create{title = 'draxware<font color="rgb(250, 3, 0)">.cc</font>',}
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        ...
                        do -- src/Lua/Scripts/da_hood/components/c_render.lua
                            ...
                            do -- indicator
                                ...
                                local title = indicatorClass:new_indicator("draxware.cc")
                                ...
                                title.changecolor(Color3.fromRGB(250, 3, 0))
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            ...
                            function config:get_list()
                                ...
                                if #listfiles("draxware/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("draxware/configs/da_hood") do
                            ...
                            getgenv().theme = {
                                accent = Color3FromRGB(250, 3, 0),
                                scroll = Color3FromRGB(250, 3, 0)
                            }
                            
                            local old_theme = table.clone(getgenv().theme)
                            local theme_objects = {}
                            
                            theme_objects["accent"] = theme_section:Colorpicker({ title = "accent", default = Color3.fromRGB(250, 3, 0), transparency = 1, callback = function (value, transparency)
                                theme.accent = value
                                theme_event:Fire()
                            end })
                            
                            theme_objects["scroll"] = theme_section:Colorpicker({ title = "scrollbar", default = Color3.fromRGB(250, 3, 0), transparency = 1, callback = function (value, transparency)
                                theme.scroll = value
                                theme_event:Fire()
                            end })
        ...
        elseif chosen_game == "universal" then
            (function() -- src/Lua/Scripts/universal/universal.lua
                ...
                local Interface = UserInterface:Create{title = 'draxware<font color="rgb(250, 3, 0)">.universal</font>',}
                ...
                do -- src/Lua/Scripts/universal/components/
                    ...
                    do -- src/Lua/Scripts/universal/components/b_render.lua
                        ...
                        fov:Colorpicker({ default = Color3.fromRGB(250, 3, 0), transparency = 0.5, callback = function (value, transparency)
                            showfov.color = value
                            showfov.transparency = transparency
                        end })
                        ...
                        line:Colorpicker({ default = Color3.fromRGB(250, 3, 0), transparency = 0.5, callback = function (value)
                            showline.color = value
                        end })
                        ...
                        local fucking_shitty_indicator = {
                            ...
                            new_indicator = function ( self, name )
                                ...
                                local indicattt = DrawingClass({ "Text", { Font = 2, Visible = false, Transparency = 1, Text = name, Outline = true, Center = true, Color = Color3.fromRGB(250, 3, 0), Size = 14 } })
                        ...
                        local title = fucking_shitty_indicator:new_indicator("draxware.universal")
                        aim_Ass_character.changecolor(Color3.fromRGB(255,255,255))
...
--[[
local Interface = UserInterface:Create{title = 'fatality<font color="rgb(250, 3, 0)">.dev</font>',}
...
aim_assist:Colorpicker({ title = "very colorpicker", default = Color3.fromRGB(250, 3, 0), transparency = 0.5, callback = function (value)
    print(value)
end })
